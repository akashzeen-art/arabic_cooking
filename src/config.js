...
export const FEATURED_RECIPES = [
  ...
  },
  {
    ...
    time: '١١ دقيقة',
    tag: 'شائع',
    image: '/thumbnails_new/دجاج البونلس الشهير صار فيكم تعملوه بالبيت Boneless Chicken.mp4.png',
...
export const TESTIMONIALS = [
  {
    id: 't1',
    quote: 'الإيقاع رائع — أخيراً فهمت كيف أتحكم بالحرارة. يبدو كأنه درس خاص في مطبخي!',
    name: 'أحمد الخالدي',
    role: 'طاهي منزلي، عمّان',
  },
  {
    id: 't2',
    quote: 'وصفات رائعة ومفيدة جداً. بات عندي شغف حقيقي بالطبخ بعد ما شاهدت هذه الفيديوهات!',
    name: 'سارة العمري',
    role: 'مصممة، بيروت',
  },
  {
    id: 't3',
    quote: 'تصوير رائع وأساليب عملية. جربت وصفة الكفتة وطلعت بشكل مذهل!',
    name: 'محمد الناصر',
    role: 'مصوّر، الرياض',
  },
]
